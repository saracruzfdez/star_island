...
<body class="bg-dark">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-1">
            ...
            <a class="navbar-brand p-0" href="<?= BASE_PATH; ?>"><img id="logo" src="assets\img\starisland.png"></a>
            ...
            <div class="collapse navbar-collapse " id="navbarColor01">
                <ul id="ul-nav" class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?= BASE_PATH.'galerie.php';?>">GALLERIE</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?= BASE_PATH.'vip.php';?>">VIP</a>
                    </li>
                    <li class="nav-item">
                ...
                <div id="tutoEvent">
                    <a class="nav-link text-white tutoEvent align-items-center" id="nav-link" href="https://openclassrooms.com/fr/">
                        <img class="m-1" id="home" src="assets\img\tuto.png" alt="">
                        <p class="m-1">TUTORIELS</p>
                    </a>
                    <a class="nav-link text-white tutoEvent" href="<?= BASE_PATH.'event.php'; ?>">
